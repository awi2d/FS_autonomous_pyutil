...
def avg_pxprom_from_conekeypoints(keypoints: [(normalised_px_w, normalised_px_h)], bounding_box: cone_bounding_box) -> float:
    ...
    for (i, j) in indexe:
        ...
        avg += obj_Distm[(i, j)]/abs_value(keypoints[i]-keypoints[j])  # TODO divide by 0, better use meadian instead of average
    avg /= len(indexe)
...
def true_pos_from_droneimg_pxpos(point_file=None) -> ([gps_util.gps_pos_radiant], [gps_util.gps_pos_radiant], [gps_util.gps_pos_radiant], {int: [gps_util.gps_pos_radiant]}):
    #fixpoitns_gpspos, blue_cone_gpspos, yellow_cone_gpspos, carpos = true_pos_from_droneimg_pxpos()
    ...
    if point_file is None:
        ...
        gps_pos_optimised = [(0.8982182236819931,0.11761677310346946), (0.8982240285990689,0.11761440344196065), (0.8982228169499672,0.1176191731534244), (0.8982243857055304,0.11761646799953861), (0.8982244272295614,0.11761613527823055), (0.8982213992764371,0.11761595966588897), (0.8982214031358772,0.11761597084013052), (0.8982214020442711,0.11761595884121227), (0.8982214018597375,0.11761595785485679), (0.8982207131168561,0.11761734720072291), (0.8982209763769827,0.11761696831244126), (0.898221544260038,0.11761655913421867), (0.8982223079788608,0.1176162657838665), (0.8982230486330698,0.11761596754024745), (0.8982238097846585,0.11761566679496416), (0.8982245597044595,0.11761548918063039), (0.8982249818242597,0.11761517269435269), (0.8982253367741706,0.11761458135442443), (0.898225502922727,0.11761382209937682), (0.8982254472582204,0.11761301835831083), (0.8982252112340988,0.11761232896301158), (0.8982248522263561,0.11761184704407193), (0.8982243293326025,0.11761159745285557), (0.8982238393644748,0.11761168467346196), (0.8982233695685794,0.1176121005896774), (0.8982231230419087,0.11761274078428265), (0.8982230215275815,0.11761343450739913), (0.8982229212541073,0.11761399343024205), (0.8982227180795478,0.11761428354116484), (0.8982220629907104,0.11761461052517863), (0.8982212962358875,0.11761490552327286), (0.8982206118289464,0.1176152517657923), (0.8982198775329606,0.117615533408022), (0.8982191855991039,0.11761591167519017), (0.8982185024008342,0.11761621572274127), (0.8982180848119797,0.11761639940107585), (0.8982176485207539,0.11761701159822766), (0.8982174344952998,0.11761770505098852), (0.8982174382314032,0.11761859028158997), (0.8982176248303,0.11761923567885321), (0.8982180534665406,0.11761987772870766), (0.8982185840395064,0.11762012295589162), (0.8982190701054829,0.1176200483323836), (0.898219692797932,0.11761944803536654), (0.898219930023695,0.11761885065742352), (0.8982200713870444,0.11761851173726715), (0.8982202861779581,0.11761812286447482), (0.898220351323496,0.11761685472481187), (0.8982206480677877,0.11761641691162851), (0.8982214286541655,0.11761591589700823), (0.8982222014379284,0.1176156162179554), (0.8982229680289275,0.11761530575469735), (0.8982236845683027,0.11761502633253793), (0.8982244163256434,0.11761472698998271), (0.8982247024345799,0.11761452051177344), (0.8982249082596623,0.11761415722148537), (0.898225003897498,0.11761370178132348), (0.8982249652979687,0.1176132290212282), (0.8982248117299104,0.11761281344203205), (0.8982245728722968,0.1176125094383236), (0.8982242817228284,0.1176123907119573), (0.8982239773853069,0.11761244841917529), (0.8982237122818619,0.11761268060089929), (0.8982235279230021,0.11761305911568545), (0.898223434164994,0.11761351528680497), (0.8982233425732734,0.11761425266045067), (0.8982231754459242,0.11761470903283265), (0.8982228625202641,0.11761495421513127), (0.8982225401992272,0.11761509282259136), (0.8982221232592783,0.11761525575358218), (0.8982213786816644,0.11761555437053249), (0.8982206964005282,0.11761589577728984), (0.8982200101919608,0.11761617247210972), (0.8982193121284029,0.11761655740983645), (0.8982185767804904,0.11761699969709224), (0.8982182742865892,0.11761714214775011), (0.8982180550233975,0.11761749269428182), (0.89821792224013,0.11761794161293515), (0.8982179386996468,0.11761843979825619), (0.8982180818644202,0.11761888825424989), (0.8982183269231553,0.11761921018826357), (0.8982186434260429,0.11761933549797822), (0.8982189653906372,0.11761926099651596), (0.8982192809647792,0.11761895849121237), (0.8982194605743373,0.11761853334525364), (0.8982196453809128,0.11761807221101686), (0.8982198982721809,0.11761760236139156), (0.89822013642814,0.11761722655662844)]
        ...
        print("carpos =", str(carpos).replace("array(", "np.array("))
    ...
    fixpoitns_gpspos = gps_pos_optimised[poii_const_points_range[0]:poii_const_points_range[1]]
    blue_cone_gpspos = gps_pos_optimised[poii_bluecones_range[0]:poii_bluecones_range[1]]
    yellow_cone_gpspos = gps_pos_optimised[poii_yellowcones_range[0]:poii_yellowcones_range[1]]
    return fixpoitns_gpspos, blue_cone_gpspos, yellow_cone_gpspos, carpos
...
def get_boundingboxes(cam: str, framenr: int) -> [cone_bounding_box]:
    bounding_box_dir = pathlib.Path("C:/Users/Idefix/PycharmProjects/datasets/fscoco_sample_translated/labels")
...
def get_cone_keypoints(cam, framenr, cone) -> [(normalised_px_w, normalised_px_h)]:
    cone_keypoints_file = pathlib.Path("C:/Users/Idefix/PycharmProjects/datasets/keypoints/cone_annotations.csv")
...
def get_poii_positions(cam, framenr) -> [(normalised_px_w, normalised_px_h)]:
    ...
    if len(poii_pxpos.keys()) == 0:
        file = "C:/Users/Idefix/PycharmProjects/datasets/keypoints/droneview_annotations.csv"
        with open(file) as f:
            for line in f.readlines():
...
def get_poii(cam: str, framenr: int, conenr: int) -> poii_id:
    file = f"C:/Users/Idefix/PycharmProjects/datasets/testrun_2022_12_17/bbi_poii/{cam}_frame_{framenr}.txt"
    with open(file) as f:
        lines = f.readlines()
...
def custom_pnp_find_parameters():
    #run 3 (14:46)
    gps_pos = [(0.898218219196664,0.11761677384927945), (0.8982240263633601,0.11761440048511256), (0.8982228208377531,0.11761917699687374), (0.8982243851864168,0.11761646624489688), (0.8982244265640591,0.11761613035106883), (0.8982218946550489,0.11761559814002326), (0.8982218938811084,0.11761570098767488), (0.8982218149295176,0.11761558849952686), (0.8982218156214595,0.11761568281976631), (0.898220710983085,0.11761735052795479), (0.898220978494443,0.11761696934924652), (0.8982215456554087,0.1176165589296821), (0.8982223091257496,0.11761626454942113), (0.8982230487531687,0.11761596120613443), (0.8982238102598032,0.11761566273739824), (0.8982245598301507,0.11761548097132278), (0.8982249870659813,0.11761516890051886), (0.8982253377320112,0.11761457351741167), (0.8982255063560869,0.1176138166202877), (0.8982254417874138,0.11761300752690491), (0.8982252066406282,0.11761231329768941), (0.8982248452265666,0.11761182984846542), (0.8982243198428156,0.11761158278914603), (0.8982238335827609,0.1176116613067907), (0.898223361984392,0.11761209061621343), (0.8982231161606045,0.11761272297037856), (0.8982230191214551,0.11761342217100187), (0.898222915051808,0.1176139797115508), (0.8982227126497527,0.11761427495956295), (0.8982220583954695,0.11761459772454162), (0.8982212939134352,0.11761489442892041), (0.8982206047210792,0.11761524097804477), (0.898219869335219,0.1176155300751091), (0.898219178245082,0.11761590604955019), (0.8982184915495137,0.11761620408389882), (0.8982180777163289,0.1176163952015395), (0.8982176416208973,0.11761701177458551), (0.898217430957465,0.1176177163612042), (0.8982174374194676,0.11761859771040431), (0.8982176254689792,0.11761924547658863), (0.8982180576473158,0.11761989621541709), (0.898218589784458,0.11762013926499308), (0.8982190816576179,0.11762006481849195), (0.8982196962977222,0.1176194612651902), (0.8982199340976174,0.11761885410670762), (0.898220071904213,0.11761851946248372), (0.8982202888353831,0.11761812866047128), (0.8982203507713146,0.11761685217122334), (0.8982206459024316,0.1176164149578317), (0.8982214284084625,0.11761591559656409), (0.8982222029890452,0.11761561188460036), (0.898222967750002,0.1176152993564572), (0.8982236824628241,0.11761502403366299), (0.8982244192117744,0.11761472238430348), (0.8982247045071223,0.11761451225122162), (0.8982249096590265,0.11761414911534866), (0.8982250072298149,0.11761369099046028), (0.8982249614609337,0.11761321716279867), (0.8982248072729057,0.11761280105367879), (0.8982245669728158,0.1176124952791572), (0.8982242740079597,0.11761237300886834), (0.8982239703596181,0.11761243096935899), (0.8982237053549882,0.11761267268776333), (0.8982235223021843,0.11761305154077652), (0.8982234265960101,0.11761350536866697), (0.8982233409236279,0.1176142456812405), (0.8982231742148179,0.11761470490248802), (0.8982228598869461,0.11761494843930137), (0.8982225364027688,0.11761508542012415), (0.8982221200565467,0.11761524341376464), (0.8982213755722425,0.11761554807805627), (0.8982206936194123,0.11761589106571084), (0.8982200051432438,0.11761616782657454), (0.8982193083875797,0.11761655419450856), (0.8982185724863053,0.117616995783369), (0.8982182705560944,0.11761714058233069), (0.898218049845183,0.11761748925418344), (0.8982179184728051,0.1176179427819382), (0.898217935170833,0.11761844320110212), (0.898218080845213,0.11761889524618208), (0.8982183272257223,0.11761921950259445), (0.8982186438165033,0.11761934968664887), (0.898218967330849,0.11761927794497112), (0.8982192838198799,0.11761896785619438), (0.8982194631694919,0.11761854184059344), (0.8982196467080553,0.11761808439862703), (0.8982199006040388,0.11761760611102237), (0.8982201370314852,0.11761723655621349)]  # with new gps_util method
    #gps_pos = [gps_util.degree_to_radiants(gps) for gps in [(51.46411414940673,6.738944977588712), (51.46444738631447,6.738809863549967), (51.464376920188684,6.739083154724557), (51.46446718888097,6.738927768062857), (51.46447029093418,6.738909215184113), (51.46433948081566,6.738858198040306), (51.464340634576544,6.738867556464109), (51.464332301312695,6.738860518358256), (51.46433352256563,6.7388693023431845), (51.46425560352164,6.738978243689988), (51.46427108152239,6.738956349310485), (51.46430420716902,6.738933864796242), (51.46434835826103,6.738916791956062), (51.46439114717442,6.738898908652391), (51.464435010009225,6.738881909437699), (51.46447785743073,6.738871411732899), (51.46450255330567,6.738853593635997), (51.464523350787786,6.738819787999573), (51.464533504173595,6.738776268215176), (51.46453037892502,6.738730218636211), (51.464517197636866,6.7386905132803125), (51.46449659091481,6.738663015861728), (51.46446663771645,6.738648698012101), (51.464438661684675,6.738653402331532), (51.46441130495734,6.738677405727721), (51.46439626718731,6.73871541407409), (51.464389944382496,6.7387554556266025), (51.46438436411264,6.738785735746747), (51.46437249221701,6.738802412049573), (51.46433474605532,6.738820935341453), (51.46429112213464,6.738838149987502), (51.46425084032891,6.738857744036035), (51.46420852749894,6.73887419245192), (51.46416856291396,6.738895720484548), (51.46412900038989,6.738912834604563), (51.46410496482645,6.738923655505124), (51.464079595253736,6.738958957232722), (51.464067119195114,6.738998752044335), (51.464066961660166,6.739049464522678), (51.46407733183846,6.739086333417893), (51.46410152721491,6.739123619222857), (51.46413179871855,6.739137612689789), (51.46415989439572,6.7391333201885475), (51.46419621559581,6.739098942910411), (51.464209958613,6.739064370135348), (51.464218071281536,6.739045220236359), (51.464230863835915,6.739022540553707), (51.464235195017565,6.73894986483897), (51.46425254304922,6.738924631810385), (51.464298461923505,6.738896452978141), (51.4643428654891,6.7388789814292425), (51.46438668534625,6.738860624573461), (51.46442779156127,6.7388451840515105), (51.46447030037779,6.7388281064257844), (51.46448691323747,6.738816478338111), (51.46449890894766,6.738795981253502), (51.46450483971843,6.738769736369862), (51.4645028126984,6.738742394083106), (51.464494201192664,6.738718220083149), (51.464480374977576,6.738700955868589), (51.46446375293953,6.738694369123524), (51.464446342496,6.7386975953166015), (51.46443094576782,6.738710948324009), (51.46442003090998,6.738732241930608), (51.46441452623774,6.738758460709004), (51.4644094765204,6.738799210265234), (51.464398695574275,6.738827028726462), (51.464380796405976,6.738840788713605), (51.4643624111585,6.738848593652515), (51.4643380159601,6.738858309555241), (51.46429508893946,6.738875725158482), (51.46425547308892,6.738894756649162), (51.464215777303274,6.738910776637766), (51.46417554371516,6.7389327114558935), (51.46413319131306,6.738958079522211), (51.46411580753114,6.73896635691615), (51.46410299161643,6.738986446365815), (51.46409511800807,6.7390122939678285), (51.46409565819885,6.739041007544318), (51.46410386007197,6.739066872605536), (51.4641179539995,6.739085351021696), (51.46413588370013,6.739092211889237), (51.464154482508064,6.739087866698141), (51.464172734232235,6.739071377317364), (51.464183024539835,6.739047157912321), (51.46419395425206,6.739020047700429), (51.46420877083953,6.738992929967574), (51.46422267511233,6.738971629815222)]]  # made without gps_util, but fitted over measured distance between cones
    ...
    for k in carpos.keys():
        carpos[k] = [gps_util.degree_to_radiants(carpos[k][i]) for i in range(4)]
    ...
    coneboundingboxes_camL3_2032 = {  # TODO replace by reading bbi_poii/camL3_frame_2032.txt and labels/camL3_frame_2032.txt
    ...
    for data in datas:
        ...
        #car_gpspos = (np.average([x for (x, y) in car_gpsposes]), np.average([y for (x, y) in car_gpsposes]))  # car pos at center of car
        ...
        # car_gpspos and _bearing from sensordata:


        print(f"bearing = {car_bearing}")  # car_bearing = 0: front axis is north of rear axis
        seen_kones_poii = list(cone_keypoints.keys())

        tmp = [gps_util.gps_to_distazimuth(gps_pos[i], car_gpspos) for i in seen_kones_poii]
        true_dist = [dist for (dist, azimuth) in tmp]
        true_angle = [to_range(azimuth-car_bearing) for (dist, azimuth) in tmp]

        print(f"true_angle {name}= ", true_angle)
        ...
        #fit_linpp_and_print(in_x=est_from, out_true=true_dist, name=f"dist_{name}")

        # car_bearing+fun(est_from, parameters) = bearing(cone, car)
        ...
        fit_linpp_and_print(in_x=est_from, out_true=true_angle, name=f"bearings_{name}")
        ...
        #imgsize_h, imgsize_w = (1200, 1920)
        #for k in seen_kones_poii:
        #    cls, posw, posh, sizew, sizeh = cones[k]
        #    keypoints = np.array([((posw-0.5*sizew+w*sizew)*imgsize_w, (posh-0.5*sizeh+h*sizeh)*imgsize_h) for (w, h) in cone_keypoints[k]])
        ...
        #    print("true_dist = ", poii_cone_meterpos[k])
        #    print(f"dists = {abs_value(tvec)} = {abs_value(poii_cone_meterpos[k])}")
...
def custom_pnp_validate():
    labeld_frames = [(2632, 4029), (2032, 3279)]  # (camL3_framnr, drone3_framenr)]
    cls_est_true_pos = []
    fixpoitns_gpspos, blue_cone_gpspos, yellow_cone_gpspos, dronefrmrn_carposes = true_pos_from_droneimg_pxpos()
    ...
    # < visual pipeline modified
        ...
        for i, bb in enumerate(bounding_boxes):
            ...
            if keypoints is not None:
                ...
                if poii_bluecones_range[0] <= poii < poii_bluecones_range[1]:
                    true_pos_poii = blue_cone_gpspos[poii-poii_bluecones_range[0]]
                elif poii_yellowcones_range[0] <= poii < poii_yellowcones_range[1]:
                    true_pos_poii = yellow_cone_gpspos[poii-poii_yellowcones_range[0]]
                else:
                    print(f"poii = {poii} of get_poii(camL3, {camL3_framenr}, {i}) not in range blue {poii_bluecones_range} or yellow {yellow_cone_gpspos}")
                    true_pos_poii = (0, 0)
                true_pos = np.array(gps_util.gps_to_meter(true_pos_poii, gps_base=gps_base))
    ...
    # >
        ...
        tmp = [gps_util.gps_to_meter(yc, gps_base=gps_base) for yc in yellow_cone_gpspos if gps_util.gps_to_dist(yc, gps_base) < 20]
        axe.scatter(x=[t[1] for t in tmp], y=[t[0] for t in tmp], c="black", marker='x', label="true_pos_yellow_unseen")
        tmp = [gps_util.gps_to_meter(bc, gps_base=gps_base) for bc in blue_cone_gpspos if gps_util.gps_to_dist(bc, gps_base) < 20]
        axe.scatter(x=[t[1] for t in tmp], y=[t[0] for t in tmp], c="black", marker='o', label="true_pos_blue_unseen")
        # plot vision cone
        ...
        for (cls, est_pos, true_pos) in cls_est_true_pos[new_cetp_startindex:]:
            ...
            axe.scatter(x=[est_pos[1]], y=[est_pos[0]], c=color, label="true_pos_seen")
    ...
    axe.grid()
    fig.savefig(vis_out_path / f"visual_pipeline_accuracy.png")
    fig.show()


def custom_PnP(keypoints: [(normalised_px_w, normalised_px_h)], bounding_box) -> (gps_util.meter, gps_util.heading_radiants):
    # custom_pnp_get_parameters: linear function:
    #  parameters[dist_total] = [1.86613152e+03 9.63512329e-02]
    #  diff_dist_total =  3.0686898319130065
    #  parameters[bearing_total] = [ 1.02105188 -0.97115736]
    #  diff_bearing_total =  0.16419475402304215
    # custom_pnp_get_parametes: linear+-1 function:
    #  parameters[dist_total] = [ 1.02987763e+03  6.71771333e+04 -1.54165913e-03  2.61240044e+00]
    #  diff_dist_total =  2.8366278614371168
    #  parameters[bearing_total] = [ 0.75420343  0.29276001  0.00630096 -0.96385143]
    #  diff_bearing_total =  0.1140167747259108
    cls, posw, posh, sizew, sizeh = bounding_box
    ...
    dist = 1.02987763e+03*mpropx + 6.71771333e+04*mpropx**2 - 1.54165913e-03/mpropx + 2.61240044e+00
    ...
    angle = 0.75420343*w + 0.29276001*w**2 + 0.00630096/w - 0.96385143
...
def plot_cones(car_pos: [gps_util.gps_pos_radiant], yellow_cones: [gps_util.gps_pos_radiant], blue_cones: [gps_util.gps_pos_radiant], name: str=None, blue_cones_labes: [str]=None, yellow_cones_labes: [str]=None) -> plot:
    ...
    if car_pos is not None:
        ...
        axe.scatter([long for (lat, long) in car_pos], [lat for (lat, long) in car_pos], color="black")
    if len(car_pos) > 1:
...
def print_synced_pos_bearing_from_drone_and_sensors():
    ...
    for k in bearing.keys():
        ...
        print(f"gps_heading.at({k/25+td}={i}) = {gps_heading} = {(bearing[k]+np.pi)*180/np.pi} = bearing[{k}]")
    for k in carpos.keys():
...
def test_Slam():
    ...
    fixpoitns_gpspos, blue_cone_gpspos, yellow_cone_gpspos, carpos = true_pos_from_droneimg_pxpos()  # true_pos_from_droneimg_pxpos("C:/Users/Idefix/PycharmProjects/datasets/keypoints/droneview_annotations.csv")
    ...
    car_pos = []
    seeing_cones = []  # (color:int, [meterpos], added:bool)
    seen_cones = []
    for frnr in range(1282, 2643, 5):  # frnr of camL3
        ...
        #t_head, i_head = get_at_time(x=gps_heading_x, y=gps_heading_y, t=t)
        t_lat = gps_lat_y[i_long]
        t_head = gps_heading_y[i_long]
        #if not i_lat == i_long == i_head:  # +250 per iteration
        #    print("(t, i_lat, long, head) =", (t, i_lat, i_long, i_head))
        car_mpos = gps_util.gps_to_meter((t_lat, t_long), base_gpspos)
        #car_mpos += gps_util.distazimuth_to_meter(1, car_bearing)  # TODOconvert base_gpspos from rear right wheel to center of car
        blue_cones, yellow_cones = visual_pipeline(cam="camL3", framenr=frnr, car_pos=car_mpos, car_bearing=t_head)

        # nonSLAM
        for (cls, conepos) in [(0, bc) for bc in blue_cones]+[(1, yc) for yc in yellow_cones]:
            f = True
            for sc in seeing_cones:
                if sc[0] == cls and (conepos[0]-sc[1][-1][0])**2 + (conepos[1]-sc[1][-1][1])**2 < 1:  #  same color and less then 1 meter appart -> same cone
                    ...
                    break
            if f:
                seeing_cones.append([cls, [conepos], True])
        [seen_cones.append((sc[0], (np.average([lat for (lat, long) in sc[1]]), np.average([long for (lat, long) in sc[1]])))) for sc in seeing_cones if not sc[2] and len(sc[1]) > 3]
        seeing_cones = [sc for sc in seeing_cones if sc[2]]
        seeing_cones = [[cls, t, False] for (cls, t, _) in seeing_cones]
        car_pos.append(car_mpos)
        all_blue_cones += blue_cones
        all_yellow_cones += yellow_cones

    #plot cones
    all_blue_cones = [conepos for (cls, conepos) in seen_cones if cls == 0]
    all_yellow_cones = [conepos for (cls, conepos) in seen_cones if cls == 1]
    plot_cones(car_pos=car_pos, yellow_cones=all_yellow_cones, blue_cones=all_blue_cones, name="cone_position from visual_pipeline_droneparams")
    fig, (axe) = plt.subplots(1)
    axe.set_title("cone_position from visual_pipeline_droneparams")
    tmp = [gps_util.gps_to_meter(pos, base_gpspos) for pos in list(blue_cone_gpspos)+list(yellow_cone_gpspos)]
    axe.scatter(x=[long for (lat, long) in tmp], y=[lat for (lat, long) in tmp], color="brown", s=5)
    axe.scatter(x=[long for (lat, long) in all_yellow_cones], y=[lat for (lat, long) in all_yellow_cones], color="yellow", s=1)
    axe.scatter(x=[long for (lat, long) in all_blue_cones], y=[lat for (lat, long) in all_blue_cones], color="blue", s=1)
    axe.grid()
    axe.set_xlabel("long")
    axe.set_ylabel("lat")
    fig.show()
...
def all_functions():
    # just a list of all functions. shoud never be called.
    exit(1)
    # namespace util:
