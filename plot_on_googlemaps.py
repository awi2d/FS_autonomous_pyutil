#https://stackoverflow.com/questions/53873673/plot-data-on-satellite-maps
...
class CustomGoogleMapPlotter(GoogleMapPlotter):
    ...
    def color_scatter(self, lats, lngs, values=None, c="black", size=None, marker=False, s=None, **kwargs):
        def rgb2hex(rgb):
